...
## 2024-05-24 - Touch-Friendly Numeric Inputs
**Learning:** Mobile and touch-screen users often struggle with precise numeric inputs.
**Action:** Always wrap standard numeric inputs with explicitly sized, touch-friendly increment and decrement controls (e.g., + and - buttons) to improve touch usability.

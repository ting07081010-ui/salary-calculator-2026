                    ...
                    <div className="class-card-info">
                        <div className="class-card-controls">
                            <select
                                ...
                                aria-label={`第 ${index + 1} 個班級的類型`}
                            >
                                {CLASS_TYPES.map(t => (
                                    <option key={t.value} value={t.value}>{t.label}</option>
                                ))}
                            </select>
                            <div className="frequency-toggle print-hidden" role="group" aria-label={`第 ${index + 1} 個班級的頻率`}>
                                <button

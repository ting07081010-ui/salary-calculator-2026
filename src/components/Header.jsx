        ...
        <header className="header">
            <div className="header-content">
                ...
                <div className="header-controls">
                    {/* 模式切換 */}
                    <div className="mode-toggle" role="radiogroup" aria-label="選擇教師類型">
                        <button
                            role="radio"
                    ...
                    <div className="toolbar">
                        <button onClick={copyShareLink} className="toolbar-btn" title="複製分享連結" aria-label="複製分享連結">
                            ...
                            <span className="toolbar-btn-text" aria-live="polite">{copySuccess ? '已複製' : '分享'}</span>
                        </button>
                        <button onClick={exportAsImage} disabled={isExporting} className="toolbar-btn" title="匯出圖片" aria-label="匯出圖片" aria-busy={isExporting}>
                        ...
                        <button onClick={printReport} className="toolbar-btn" title="列印" aria-label="列印報告">

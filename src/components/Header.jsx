            ...
            <div className="header-content">
                <div className="header-title">
                    ...
                    <div className="header-icon">
                        <Calculator className="icon-sm" aria-hidden="true" />
                    </div>
                    <h1>薪資試算 2026</h1>
                </div>
                ...
                <div className="header-controls">
                    {/* 模式切換 */}
                    <div className="mode-toggle" role="radiogroup" aria-label="選擇老師類型">
                        <button
                            role="radio"
                    ...
                    <div className="toolbar">
                        <button onClick={copyShareLink} className="toolbar-btn" title="複製分享連結" aria-label="複製分享連結">
                        ...
                        <button onClick={exportAsImage} disabled={isExporting} className="toolbar-btn" title="匯出圖片" aria-label="匯出為圖片" aria-busy={isExporting}>
                            <Camera className={`icon-sm ${isExporting ? 'animate-pulse' : ''}`} aria-hidden="true" />
                        </button>
                        <button onClick={exportToCSV} className="toolbar-btn" title="匯出 CSV" aria-label="匯出為 CSV">

        ...
        <header className="header">
            <div className="header-content">
                <div className="header-title">
                    <a href="/" className="text-slate-400 hover:text-indigo-600 transition-colors flex items-center" aria-label="回首頁">
                ...
                <div className="header-controls">
                    ...
                    <div className="toolbar">
                        ...
                        <button onClick={exportAsImage} disabled={isExporting} className="toolbar-btn" aria-label="匯出圖片" aria-busy={isExporting}>
                            <Camera className={`icon-sm ${isExporting ? 'animate-pulse' : ''}`} aria-hidden="true" />
                        </button>
                        <button onClick={exportToCSV} className="toolbar-btn" aria-label="匯出 CSV">
                            <Download className="icon-sm" aria-hidden="true" />
                        </button>
                        <button onClick={printReport} className="toolbar-btn" aria-label="列印報表">

            ...
            <div className="header-content">
                ...
                <div className="header-controls">
                    ...
                    <div className="toolbar">
                        ...
                        <button onClick={exportAsImage} disabled={isExporting} className="toolbar-btn" title="匯出圖片" aria-label="匯出成圖片">
                            <Camera className={`icon-sm ${isExporting ? 'animate-pulse' : ''}`} aria-hidden="true" />
                        </button>
                        <button onClick={exportToCSV} className="toolbar-btn" title="匯出 CSV" aria-label="匯出成 CSV">
                            <Download className="icon-sm" aria-hidden="true" />
                        </button>
                        <button onClick={printReport} className="toolbar-btn" title="列印" aria-label="列印薪資明細">

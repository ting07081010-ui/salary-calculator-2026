                ...
                <div className="header-controls">
                    ...
                    <div className="mode-toggle" role="group" aria-label="切換教師類型">
                        ...
                        <button
                            ...
                            aria-pressed={teacherType === TEACHER_TYPES.PT}
                        >
                            PT
                        </button>
                    </div>
                    ...
                    <div className="toolbar">
                        <button onClick={copyShareLink} className="toolbar-btn" title="複製分享連結" aria-label={copySuccess ? '已複製連結' : '複製分享連結'}>

        ...
        <div className={`boss-class-config ${cls.level === 'advanced' ? 'advanced' : ''}`}>
            ...
            <div className="boss-class-header">
                <div className="boss-class-buttons">
                    <button
                        ...
                        aria-label={`班級 ${index !== undefined ? index + 1 : ''} 頻率切換`}
                    >
                    ...
                    <button
                        ...
                        aria-label={`班級 ${index !== undefined ? index + 1 : ''} 等級切換`}
                    >
            ...
            <div className="boss-class-controls">
                <select
                    ...
                    aria-label={`班級 ${index !== undefined ? index + 1 : ''} 類型`}
                >
                ...
                <input
                    ...
                    aria-label={`班級 ${index !== undefined ? index + 1 : ''} 學生人數`}
                />
            </div>
                ...
                <div className="boss-pt-class-hours">
                    <span className="boss-pt-hours-label">
                        ...
                        <input
                            ...
                            aria-label={`班級 ${index !== undefined ? index + 1 : ''} 每月授課時數`}
                        /> hr
                    </span>
            ...
            <div className="boss-class-footer">
                ...
                <button
                    ...
                    aria-label={`移除班級 ${index !== undefined ? index + 1 : ''}`}
                >
                    Remove
                </button>
            </div>
